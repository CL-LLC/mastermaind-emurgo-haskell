...
/* package scape-room-0.1.0.0 */
#ifndef VERSION_scape_room
#define VERSION_scape_room "0.1.0.0"
#endif /* VERSION_scape_room */
#ifndef MIN_VERSION_scape_room
#define MIN_VERSION_scape_room(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_scape_room */
...
#define CURRENT_COMPONENT_ID "scape-room-0.1.0.0-inplace-scape-room"
